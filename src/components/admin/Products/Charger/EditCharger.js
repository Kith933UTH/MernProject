...
const EditCharger = () => {
	...
	const detailData = [
		...
		{ type: 'Function', value: 'Charging' },
		{ type: 'Input', value: '100-240V~50/60Hz, 0.6A' },
		{
			type: 'Output',
			value: 'Type C: 5V - 3A, 9V - 2.22A, 12V - 1.67A (Max 20W)',
		},
		{ type: 'Maximum charging current', value: '20 W' },
		{ type: 'Size', value: 'Length 2.7 cm - Width 2.7 cm - Height 3.1 cm' },
		{ type: 'Technology/Gadgets', value: 'Power Delivery' },
