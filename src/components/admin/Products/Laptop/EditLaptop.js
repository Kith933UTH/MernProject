					...
					<div className="w-full bg-white rounded-md border-[1px] border-solid border-gray-300 shadow-sm shadow-gray-400">
						<form className="grid grid-cols-2">
							...
							<div className="mb-4">
								...
								<DetailItem list={detailData.processor} />
							</div>
							{/* ram, hard drive  */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
								...
								<DetailItem list={detailData.ramAndHardDrive} />
							</div>
							{/* screen */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
							...
							<div className="mb-4">
								...
								<DetailItem
									list={
										detailData.connectionPortsAndExpansionFeatures
									}
								/>
							</div>
							{/* Size, weight */}
							<div className="mb-4">
								...
								<DetailItem list={detailData.sizeAndWeight} />
							</div>
							{/* Other information */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
