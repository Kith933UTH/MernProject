...
const DetailItem = ({ list }) => {
	return list.map((item) => (
		<div className="px-4 py-2 pt-0" key={item.type}>
			<Typography className="text-sm font-medium">{item.type}</Typography>
			<input
				type="text"
				...
				<div className="w-full flex flex-col gap-4">
					...
					<div className="w-full bg-white rounded-md border-[1px] border-solid border-gray-300 shadow-sm shadow-gray-400">
						<form className="grid grid-cols-2">
							...
							<div className="mb-4">
								...
								<DetailItem list={detailData.screen} />
							</div>
							{/* Selfie camera  */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
								...
								<DetailItem list={detailData.selfieCamera} />
							</div>
							{/* Main camera */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
								...
								<DetailItem list={detailData.mainCamera} />
							</div>
							...
							<div className="mb-4">
								...
								<DetailItem list={detailData.osAndCpu} />
							</div>
							{/* Memory, Storage */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
							...
							<div className="mb-4">
								...
								<DetailItem list={detailData.connection} />
							</div>
							{/* Battery */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
								...
								<DetailItem list={detailData.battery} />
							</div>
							{/* Utilities */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
								...
								<DetailItem list={detailData.utilities} />
							</div>
							{/* General information */}
							<div className="mb-4">
								<Typography className="p-4 pb-2 text-base font-bold">
					...
					<div className="grid grid-cols-2 gap-4">
						{variantList.map((variant) => (
							<VariantItem
								data={variant}
								key={variant.rom + variant.ram + variant.color}
							/>
						))}
						{/* add variant  */}
						<VariantItem />
